...
namespace WpfCheckerView.Services
{
    ...
    new Department { Id = 15, Level = 2, Name = "Sponsorship", Package = "B" }
            ...
            _employees = new ObservableCollection<Employee>
            {
                ...
                new Employee { Id = 1, Name = "Alice", Department = "IT", Salary = 50000, IdProof = "ID123", PanNo = "PAN123" },
                new Employee { Id = 3, Name = "Joy", Department = "Support", Salary = 50000, IdProof = "ID789", PanNo = "PAN123" },
                new Employee { Id = 4, Name = "Sibu", Department = "Support", Salary = 50000, IdProof = "ID124", PanNo = "PAN456" },
                new Employee { Id = 4, Name = "Sibu", Department = "Service", Salary = 50000, IdProof = "ID124", PanNo = "PAN456" },
                new Employee { Id = 6, Name = "Charlie", Department = "Finance", Salary = 55000, IdProof = "ID799", PanNo = "PAN789" }
            };
        }
